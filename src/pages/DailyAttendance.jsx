                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-white border-b border-slate-100">
                                        ...
                                        <th className="py-4 px-6 font-semibold text-xs text-slate-500 uppercase tracking-wider">
                                            <div className="flex flex-col gap-1">
                                                <span>Status</span>
                                                <select
                                                    className="bg-slate-50 border border-slate-200 rounded px-1 py-0.5 text-[10px] font-bold text-slate-600 focus:outline-none focus:ring-1 focus:ring-primary-500 transition-all pointer-events-auto cursor-pointer"
                                                    value={statusFilter}
